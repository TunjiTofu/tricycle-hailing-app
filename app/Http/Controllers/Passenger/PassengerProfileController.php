...
class PassengerProfileController extends Controller
{
    public function index()
    {
        ...
        return view('passenger.profile.index', compact('profileData'));
    }
    ...
    public function edit()
    {
        ...
        return view('passenger.profile.edit', compact('editData'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->file('photo')) {
            ...
            return redirect()->route('passenger.profile')->with($notification);
        } else {
            User::findOrFail($id)->update([
                'username' => $request->username,
                'email' => $request->email,
    ...
    {
        return view('passenger.profile.change-password');
    }
